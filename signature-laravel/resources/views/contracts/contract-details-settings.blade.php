                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('settings.update-contract-details') }}" method="POST">
                        ...
                        @include('contracts.partials.not-included-in-offer-section', [
                            'nioFieldPrefix' => 'global_not_included_in_offer',
                            'nioPrintField' => 'global_not_included_in_offer_in_print',
                            'nioShowPrint' => filter_var(old('global_not_included_in_offer_in_print', $setting->global_not_included_in_offer_in_print ?? true), FILTER_VALIDATE_BOOLEAN),
                            'nioFlags' => \App\Models\Contract::mergeNotIncludedInOfferFlags(old('global_not_included_in_offer'), $setting->global_not_included_in_offer),
                        ])
