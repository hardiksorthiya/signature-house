<x-app-layout>
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h2 fw-semibold mb-1" style="color: #1f2937;">Create Lead</h1>
            ...
            <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4 pb-3 border-bottom" style="border-color: color-mix(in srgb, var(--primary-color) 20%, transparent) !important;">
                        ...
                        <h2 class="h5 fw-semibold mb-0" style="color: #1f2937;">Add Lead</h2>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="lead_type" id="type_new" value="new" x-model="leadType" @change="switchFormType('new')" style="cursor: pointer;">
                                <label class="form-check-label" for="type_new" style="cursor: pointer; color: #374151;">
                                    New
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="lead_type" id="type_old" value="old" x-model="leadType" @change="switchFormType('old')" style="cursor: pointer;">
                        ...
                        <form action="{{ route('leads.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="quantity" required value="{{ old('quantity') }}" min="1"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="planning_month" required class="form-select @error('planning_month') is-invalid @enderror" style="border-radius: 8px; border: 1px solid #e5e7eb;">
                                        ...
                                        @foreach($planningMonths as $monthValue => $monthLabel)
                                            <option value="{{ $monthValue }}" {{ (int) old('planning_month', now()->month) === $monthValue ? 'selected' : '' }}>{{ $monthLabel }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="planning_year" required class="form-select @error('planning_year') is-invalid @enderror" style="border-radius: 8px; border: 1px solid #e5e7eb;">
                                        ...
                                        @foreach($planningYears as $planningYear)
                                            <option value="{{ $planningYear }}" {{ (int) old('planning_year', now()->year) === (int) $planningYear ? 'selected' : '' }}>{{ $planningYear }}</option>
                                        @endforeach
                                    </select>
                                    @error('planning_year')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <form action="{{ route('leads.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="machine_quantity" required value="{{ old('machine_quantity') }}" min="1"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="running_since" required value="{{ old('running_since') }}" 
