<x-app-layout>
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h2 fw-semibold mb-1" style="color: #1f2937;">Convert Lead to Contract</h1>
    ...
    <script>
        window.__initialMachinesForContract = @json($initialMachines ?? []);
    </script>
    <div class="row g-4" x-data="contractForm()" x-init="init()">
        <div class="col-12">
            <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('leads.store-contract', $lead) }}" method="POST" id="contractForm" @submit="prepareContractSubmit($event)">
                        @csrf
                        ...
                        @php $convShowBuyerExp = filter_var(old('other_buyer_expenses_in_print', $settings->global_other_buyer_expenses_in_print ?? true), FILTER_VALIDATE_BOOLEAN); @endphp
                        <div class="row mt-4 mb-4">
                            <div class="col-12">
                                <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;" x-data="{ showFields: {{ $convShowBuyerExp ? 'true' : 'false' }} }">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                ...
                                                <div class="btn-group" role="group">
                                                    <input type="radio" class="btn-check" name="other_buyer_expenses_in_print" id="buyer_expenses_show" value="1" {{ $convShowBuyerExp ? 'checked' : '' }} @change="showFields = true">
                                                    <label class="btn btn-outline-success btn-sm" for="buyer_expenses_show" style="border-radius: 6px 0 0 6px;">Show</label>
                                                    <input type="radio" class="btn-check" name="other_buyer_expenses_in_print" id="buyer_expenses_hide" value="0" {{ !$convShowBuyerExp ? 'checked' : '' }} @change="showFields = false">
                        ...
                        @php $convShowOtherDet = filter_var(old('other_details_in_print', $settings->global_other_details_in_print ?? true), FILTER_VALIDATE_BOOLEAN); @endphp
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;" x-data="{ showFields: {{ $convShowOtherDet ? 'true' : 'false' }} }">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <label class="form-label fw-medium mb-0" style="color: #374151;">In Print :</label>
                                                <div class="btn-group" role="group">
                                                    <input type="radio" class="btn-check" name="other_details_in_print" id="other_details_show" value="1" {{ $convShowOtherDet ? 'checked' : '' }} @change="showFields = true">
                                                    <label class="btn btn-outline-success btn-sm" for="other_details_show" style="border-radius: 6px 0 0 6px;">Show</label>
                                                    <input type="radio" class="btn-check" name="other_details_in_print" id="other_details_hide" value="0" {{ !$convShowOtherDet ? 'checked' : '' }} @change="showFields = false">
                        ...
                        @php $convShowSpecMain = filter_var(old('difference_specification_in_print', $settings->global_difference_specification_in_print ?? true), FILTER_VALIDATE_BOOLEAN); @endphp
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;" x-data="{ showFields: {{ $convShowSpecMain ? 'true' : 'false' }} }">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <label class="form-label fw-medium mb-0" style="color: #374151;">In Print :</label>
                                                <div class="btn-group" role="group">
                                                    <input type="radio" class="btn-check" name="difference_specification_in_print" id="specification_show" value="1" {{ $convShowSpecMain ? 'checked' : '' }} @change="showFields = true">
                                                    <label class="btn btn-outline-success btn-sm" for="specification_show" style="border-radius: 6px 0 0 6px;">Show</label>
                                                    <input type="radio" class="btn-check" name="difference_specification_in_print" id="specification_hide" value="0" {{ !$convShowSpecMain ? 'checked' : '' }} @change="showFields = false">
                        ...
                        @php $convShowSpecExt = filter_var(old('difference_specification_extended_in_print', $settings->global_difference_specification_extended_in_print ?? false), FILTER_VALIDATE_BOOLEAN); @endphp
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;" x-data="{ showFields: {{ $convShowSpecExt ? 'true' : 'false' }} }">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <label class="form-label fw-medium mb-0" style="color: #374151;">In Print :</label>
                                                <div class="btn-group" role="group">
                                                    <input type="radio" class="btn-check" name="difference_specification_extended_in_print" id="conv_spec_ext_show" value="1" {{ $convShowSpecExt ? 'checked' : '' }} @change="showFields = true">
                                                    <label class="btn btn-outline-success btn-sm" for="conv_spec_ext_show" style="border-radius: 6px 0 0 6px;">Show</label>
                                                    <input type="radio" class="btn-check" name="difference_specification_extended_in_print" id="conv_spec_ext_hide" value="0" {{ !$convShowSpecExt ? 'checked' : '' }} @change="showFields = false">
                                                    <label class="btn btn-outline-danger btn-sm" for="conv_spec_ext_hide" style="border-radius: 0 6px 6px 0;">Hide</label>
                                                </div>
                                                <button type="button" class="btn btn-sm btn-outline-secondary" @click="showFields = !showFields" :title="showFields ? 'Collapse section' : 'Expand section'">
                                                    <i class="fas" :class="showFields ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                                                </button>
                        ...
                        @php $convShowSpec3 = filter_var(old('difference_specification_3_in_print', $settings->global_difference_specification_3_in_print ?? false), FILTER_VALIDATE_BOOLEAN); @endphp
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;" x-data="{ showFields: {{ $convShowSpec3 ? 'true' : 'false' }} }">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <label class="form-label fw-medium mb-0" style="color: #374151;">In Print :</label>
                                                <div class="btn-group" role="group">
                                                    <input type="radio" class="btn-check" name="difference_specification_3_in_print" id="conv_spec_3_show" value="1" {{ $convShowSpec3 ? 'checked' : '' }} @change="showFields = true">
                                                    <label class="btn btn-outline-success btn-sm" for="conv_spec_3_show" style="border-radius: 6px 0 0 6px;">Show</label>
                                                    <input type="radio" class="btn-check" name="difference_specification_3_in_print" id="conv_spec_3_hide" value="0" {{ !$convShowSpec3 ? 'checked' : '' }} @change="showFields = false">
                                                    <label class="btn btn-outline-danger btn-sm" for="conv_spec_3_hide" style="border-radius: 0 6px 6px 0;">Hide</label>
                                                </div>
                                                <button type="button" class="btn btn-sm btn-outline-secondary" @click="showFields = !showFields" :title="showFields ? 'Collapse section' : 'Expand section'">
                                                    <i class="fas" :class="showFields ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                                                </button>
                        ...
                        <!-- Terms & conditions -->
                        @php $convShowTerms = filter_var(old('terms_conditions_in_print', $settings->global_terms_conditions_in_print ?? true), FILTER_VALIDATE_BOOLEAN); @endphp
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;" x-data="{ showFields: {{ $convShowTerms ? 'true' : 'false' }} }">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <label class="form-label fw-medium mb-0" style="color: #374151;">In Print :</label>
                                                <div class="btn-group" role="group">
                                                    <input type="radio" class="btn-check" name="terms_conditions_in_print" id="conv_terms_conditions_show" value="1" {{ $convShowTerms ? 'checked' : '' }} @change="showFields = true">
                                                    <label class="btn btn-outline-success btn-sm" for="conv_terms_conditions_show" style="border-radius: 6px 0 0 6px;">Show</label>
                                                    <input type="radio" class="btn-check" name="terms_conditions_in_print" id="conv_terms_conditions_hide" value="0" {{ !$convShowTerms ? 'checked' : '' }} @change="showFields = false">
                                                    <label class="btn btn-outline-danger btn-sm" for="conv_terms_conditions_hide" style="border-radius: 0 6px 6px 0;">Hide</label>
                                                </div>
                                                <button type="button" class="btn btn-sm btn-outline-secondary" @click="showFields = !showFields" :title="showFields ? 'Collapse section' : 'Expand section'">
                                                    <i class="fas" :class="showFields ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                                                </button>
    ...
    <script>
        function contractForm() {
            ...
            return {
                ...
                async loadCategoryItems(index, categoryId, skipAutoSelect = false) {
                    if (!categoryId) {
                    ...
                    try {
                        ...
                        if (!skipAutoSelect && items.brands && items.brands.length > 0) {
                            await this.$nextTick();
                            this.machines[index].brand_id = String(items.brands[0].id);
                            await this.loadMachineModels(index, items.brands[0].id);
                        }
                        // Convert-to-contract init uses skipAutoSelect; if lead had no brand_id, brand stays
                        // empty while the browser shows the first option — x-if(brand_id) hides Model. Pick first brand.
                        if (skipAutoSelect && items.brands && items.brands.length > 0 && !this.machines[index].brand_id) {
                            await this.$nextTick();
                            this.machines[index].brand_id = String(items.brands[0].id);
                            await this.loadMachineModels(index, items.brands[0].id);
                        }
                ...
                async init() {
                    const initial = window.__initialMachinesForContract;
                    if (Array.isArray(initial) && initial.length > 0) {
                        this.machines = initial.map(m => ({ ...defaultMachine(), ...m }));
                        for (let i = 0; i < this.machines.length; i++) {
                            const m = this.machines[i];
                            if (m.machine_category_id) {
                                await this.loadCategoryItems(i, m.machine_category_id, true);
                                const initialRow = initial[i];
                                if (initialRow && initialRow.brand_id) {
                                    this.machines[i].brand_id = String(initialRow.brand_id);
                                    await this.loadMachineModels(i, initialRow.brand_id);
                                    if (initialRow.machine_model_id) {
                                        this.machines[i].machine_model_id = String(initialRow.machine_model_id);
                                    }
                                    if (initialRow.seller_id) {
                                        this.machines[i].seller_id = String(initialRow.seller_id);
                                    }
                                }
                            }
                        }
                    }
                    delete window.__initialMachinesForContract;
                },
            ...
            if (stateSelect && stateSelect.value) {
                ...
                if (alpineElement && alpineElement._x_dataStack && alpineElement._x_dataStack[0]) {
                    ...
                    contractForm.loadCities(stateSelect.value).then(() => {
                        // Areas are already loaded inside loadCities() with preserved selection.
                    });
                } else {
