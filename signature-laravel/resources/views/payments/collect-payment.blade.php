...
<x-app-layout>
    <div x-data="{
        redirectBase: @js(route('payments.collect-payment')),
            ...
            <div class="card-header border-0 p-0" style="background: transparent;">
                <div class="list-header d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center justify-content-between py-3 px-3 px-md-4 border-bottom gap-2" style="border-color: color-mix(in srgb, var(--primary-color) 20%, transparent) !important;">
                    <div class="list-header-title-row d-flex align-items-center flex-wrap gap-2" style="min-width: 0;">
                        ...
                        <div class="min-w-0">
                            <h1 class="h2 fw-semibold mb-1 text-truncate" style="color: #1f2937;">Collect Payment</h1>
                            <p class="text-muted mb-0 small">Collect payment from an approved contract or proforma invoice</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2 flex-shrink-0 mt-2 mt-lg-0">
                        ...
                        <a href="{{ route('payments.collect-payment') }}" class="btn btn-outline-primary d-flex align-items-center" style="border-radius: 8px;">
            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <small class="text-muted">Each row is a proforma invoice; payment is recorded against that PI.</small>
                    </div>
                </div>
                <div class="d-flex gap-2 mt-3">
                    <a href="{{ route('payments.collect-payment') }}" class="btn btn-outline-secondary d-flex align-items-center" style="border-radius: 8px;">
            ...
            <form action="{{ route('payments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-header border-0 pt-4 px-4 pb-0" style="background: transparent;">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="h5 fw-semibold mb-0" style="color: #1f2937;">Collect Payment Details</h2>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-save me-2"></i>Collect Payment
                                </button>
                                <a href="{{ route('payments.collect-payment') }}" class="btn btn-outline-secondary">
